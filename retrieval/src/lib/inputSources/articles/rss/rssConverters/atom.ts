...
const getImage = (article: Record<string, string>): string | undefined => {
...
const getDescriptionAndImage = async (article: Record<string, string>) => {
...
export const convertAtomStream = (feed: Feed) => (parsedXml: any) => {
